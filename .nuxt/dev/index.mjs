import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/vue/index.mjs';
import { GraphQLClient } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/graphql-request/build/esm/index.js';
import { basename, isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/ipx/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/node_modules/@unhead/shared/dist/index.mjs';
...
const _2XH8anka8m = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt";
...
const _dvtJ0sEgLu = defineNitroPlugin(() => {
...
const _inlineRuntimeConfig = {
      ...
      "configLocales": [
        {
          ...
          "name": "Magyar HU",
          "files": [
            "/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/woonuxt_base/app/locales/hu-HU.json"
          ]
        }
      ],
      "locales": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/woonuxt_base/public"
      ]
    },
    "http": {
      "domains": [
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _1OeCyk = defineCachedEventHandler(async (event) => {
...
const _43CmpT = lazyEventHandler(() => {
...
const _lazy_MH2uQt = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_MH2uQt, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _1OeCyk, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _43CmpT, lazy: false, middleware: false, method: undefined },
  { route: '/products/**', handler: _lazy_MH2uQt, lazy: true, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_MH2uQt, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MH2uQt, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/BakonyButorWoonuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
